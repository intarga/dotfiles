# Color palette
declare-option str bg           "rgb:eff1f5" # base
declare-option str fg           "rgb:4c4f69" # text
declare-option str soft_bg      "rgb:e6e9ef" # mantle
declare-option str soft_fg      "rgb:9ca0b0" # overlay0
declare-option str alt_bg       "rgb:dce0e8" # crust
declare-option str alt_fg       "rgb:7287fd" # lavender

declare-option str red          "rgb:e64553" # maroon
declare-option str dark_red     "rgb:d20f39" # red
declare-option str green        "rgb:40a02b" # green
declare-option str dark_green   "rgb:179299" # teal
declare-option str yellow       "rgb:df8e1d" # yellow
declare-option str dark_yellow  "rgb:fe640b" # peach
declare-option str blue         "rgb:04a5e5" # sky
declare-option str dark_blue    "rgb:1e66f5" # blue
declare-option str cyan         "rgb:ea76cb" # pink
declare-option str dark_cyan    "rgb:8839ef" # mauve
declare-option str magenta      "rgb:dc8a78" # rosewater
declare-option str dark_magenta "rgb:dd7878" # flamingo
...
set-face global PrimaryCursor      "%opt{soft_bg},%opt{dark_magenta}+b"
set-face global PrimaryCursorNor   "%opt{soft_bg},%opt{dark_magenta}+b"
set-face global PrimaryCursorIns   "%opt{soft_bg},%opt{dark_magenta}+bu"
set-face global SecondaryCursor    "%opt{soft_bg},%opt{alt_fg}+b"
set-face global PrimaryCursorEol   "%opt{alt_bg},%opt{magenta}"
...
set-face global Information        "%opt{bg},%opt{yellow}+b"
set-face global Error              "%opt{soft_bg},%opt{red}"
set-face global StatusLine         "%opt{fg},%opt{soft_bg}"
set-face global StatusLineMode     "%opt{soft_bg},%opt{yellow}"
set-face global StatusLineInfo     "%opt{soft_bg},%opt{blue}"
set-face global StatusLineValue    "%opt{soft_bg},%opt{yellow}"
set-face global StatusCursor       "%opt{soft_bg},%opt{magenta}"
...
set-face global ts_constructor                  "%opt{green}+b"
...
set-face global ts_type_enum_variant_builtin    "%opt{green}+b"
set-face global ts_variable                     "%opt{dark_blue}"
